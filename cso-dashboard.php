...
<head>
  ...
  <script src="js/styles.cso.dashboard.js"></script>
  ...
  <div class="ff-row" id="body">
    <div class="col s12 ff-layout">
      <div class="ff-header">
        ...
        <a id="menu" data-target="slide-out" class="btn-floating hoverable btn-large waves-effect waves-light teal sidenav-trigger">
        ...
        <ul id="slide-out" class="sidenav noselect">
          ...
          <li><a class="subheader">Penyisihan</a></li>
          <li><a class="sidenav-close" onclick="changeContent('penyisihan-cso')">Tahap 1</a></li> -->
          <li><div class="divider"></div></li>
        ...
        <div class="ff-row row">
          <!-- Left menu -->
          <div class="dashboard-left-menu col s12 l4 ff-theme hoverable">
            <div class="dashboard-hi center">
              <a href="cso-dashboard"><img src="img/dashboard/dashboard-cso0.png" class="logo"></a>
              <div class="secondary">
                Selamat datang <font id="show-namatim"></font>
              </div>
              <!-- Dropdown trigger -->
              <div><a class="dropdown-trigger btn waves-effect teal" data-target="drop-info"><i class="fa fa-info"></i> &nbsp; Informasi</a></div>
              <div><a class="dropdown-trigger btn waves-effect teal" data-target="drop-data"><i class="fa fa-check"></i> &nbsp; Kelengkapan Data</a></div>
              ...
              <div><a class="dropdown-trigger btn waves-effect teal" data-target="drop-akun"><i class="fa fa-user"></i> &nbsp; Pengaturan Akun</a></div>
              <!-- Dropdown content -->
          ...
          <!-- Dashboard content -->
          <div class="dashboard-right-content cso col s12 l8 right">
            <div class="dashboard-margin">
              ...
              <div class="dashboard-content col m8 s12 offset-m2" id="info-lomba">
                            ...
                            <div class="card-content" style="padding: 8px 10px 10px 10px;">
                              <div class="row ff-row grey-text text-darken-2">
                                ...
                                <div class="col m11 s10">
                                  <h6 style="line-height: 25px"><b><font id="tanggal-value" style="text-transform: uppercase"></font></b></h6>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                <div class="row ff-row">
                  <div class="col s12">
                    <div class="card ff-theme white-text hoverable">
                      <div class="card-content">
                        <h5 class="content-title">
                          <i class="fa fa-question-circle"></i>&nbsp; &nbsp;POSTER
                        </h5>
                        <br>
                        <div class="card teal white-text" style="margin: 0px">
                          <div class="card-content" style="padding: 8px 5px 10px 5px;">
                            <div class="row ff-row">
                              <div class="col s12 center">
                                <h6 style="line-height: 25px"><font>POSTER CSO</font></h6>
                              </div>
                            </div>
                          </div>
                        </div>
                        <br>
                        <img src="img/poster/poster-cso-baru.png" style="width: 100%" class="materialboxed" id="poster-value">
                        <br>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card hoverable">
                      <div class="card-content">
                        ...
                        <div id="status-tim">
                          <br>
                          <p>Kategori Lomba :
                            <font id="info-show-onoff" class="teal-text"></font>
                          </p>
                          ...
                          <br>
                          <font class="teal-text" id="check-siap-lomba">
                          </font>
                          <br>
                        </div>
                      </div>
                      ...
                      <div class="card-content">
                        ...
                        <form id="upload-pembayaran" style="margin-top: 30px;" class="grey-text text-darken-2">
                          ...
                          <div class="file-field input-field">
                            <img src="img/drag/drag-photo-cso.png" id="image-preview-bayar" class="file-field input-field" accept="image/*">
                            <br><br>
                            <div class="btn teal">
                              <span>FILE</span>
                          ...
                          <div class="input-field">
                            ...
                            <font class="teal-text text-lighten-2" style="font-size: 12px">*masukkan keterangan pembayaran disini (opsional)</font>
                          </div>
                          <br>
                          <a class="waves-effect btn teal" onclick="uploadPembayaran()">&nbsp;SUBMIT&nbsp;</a>
                        </form>
                        <br>
                      </div>
                    </div>
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              <select id="banyak-anggota" class="validate" required="required" onchange="innerInputAnggota()">
                                ...
                                <option value="3">Tambah 2 Anggota</option>
                              </select>
                            </div>
                          </div>
                  ...
                  <div class="col l8 m8 s12 offset-l2 offset-m2">
                    <div class="card hoverable">
                      <div class="card-content">
                        ...
                        <br><br>
                        <a class="waves-effect btn ff-theme animated zoomIn" onclick="changeContent('data-anggota');">&nbsp;BACK&nbsp;</a>
                        <a class="waves-effect btn teal animated zoomIn" onclick="dataAnggota()">&nbsp;SUBMIT&nbsp;</a>
                        <br><br>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card hoverable teal white-text">
                      <div class="card-content">
                        ...
                        <div style="font-size: 16px !important">
                          ...
                          <br>
                          Silahkan hubungi &nbsp;&nbsp;<font class="btn ff-theme waves-effect waves-light modal-trigger" href="#admin-contact">Admin</font>&nbsp;&nbsp; jika terjadi kesalahan
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <form id="ganti-password" style="margin-top: 30px;">
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              ...
                              <font class="teal-text text-lighten-2" style="font-size: 12px">*password minimal terdiri dari 8 digit</font>
                            </div>
                          </div>
                          <div class="row">
                            <div class="input-field col s12">
                          ...
                          <p align="left" style="margin-bottom: 30px;">
                            <label>
                              ...
                              <span><a style="text-transform: none" class="teal-text">Ganti password</a></span>
                            </label>
                          </p>
                          <a class="waves-effect btn ff-theme" onclick="clearForm('#ganti-password')">&nbsp;BATAL&nbsp;</a>
                          <a class="waves-effect btn teal" onclick="gantiPass()">&nbsp;SUBMIT&nbsp;</a>
                        </form>
                        <br>
                      </div>
                    </div>
              ...
              <div class="dashboard-content" id="penyisihan-cso">
                <div class="row ff-row">
                  <div class="col l8 m8 s12 offset-l2 offset-m2">
                    <div class="card hoverable">
                      <div class="card-content">
                        <h5 class="content-title grey-text text-darken-2">
                          <i class="fa fa-hourglass-start"></i>&nbsp; &nbsp;PENYISIHAN
                        </h5>
                        <div class="card secondary teal white-text">
                          <div class="card-content">
                            TEST
